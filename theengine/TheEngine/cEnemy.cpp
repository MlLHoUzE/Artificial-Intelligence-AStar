...
void cEnemy::SetMediator(iMediator* pMediator)
{
	m_pMediator = pMediator;
}

void cEnemy::GetPhysicsInfo(sPhysicsInfo& physicsInfo)
{
	physicsInfo = this->m_physicsInfo;
}

void cEnemy::SetPhysicsInfo(sPhysicsInfo physicsInfo)
{
	m_physicsInfo = physicsInfo;
}

void cEnemy::SetPosition(glm::vec3& position, glm::quat orientation)
{
...
void cEnemy::GetRenderingInfo(sRenderingInfo& renderingInfo)
{
	renderingInfo = m_renderingInfo;
}

void cEnemy::SetRenderingInfo(sRenderingInfo renderingInfo)
{
	m_renderingInfo = renderingInfo;
}

//virtual void GetModelMatrix(glm::mat4& modelMatrix);
void cEnemy::SetID(int ID)
{
	m_ID = ID;
}
int cEnemy::GetID()
...
void cEnemy::SetWorldMatrix(glm::mat4 matModel)
{
	this->m_worldMatrix = matModel;
}

void cEnemy::GetWorldMatrix(glm::mat4& matModel)
{
...
void cEnemy::setWireframe(bool bWireframe)
{
	this->m_renderingInfo.bIsWireframe = bWireframe;
}

void cEnemy::setUseLighting(bool bUseLighting)
{
	this->m_renderingInfo.bUseDebugColors = bUseLighting;
}

void cEnemy::updatePhysicsTris()
{}